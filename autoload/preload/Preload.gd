...
const ENEMY := {
	...
	CHASER_GROUP = "res://enemies/chaser/ChaserGroup.tscn",
	CHASER = "res://enemies/chaser/Chaser.tscn",
	TRIANGLE = "res://enemies/triangle/Triangle.tscn",
	AGGRESSIVE_CHASER = "res://enemies/aggressive_chaser/AggressiveChaser.tscn",
